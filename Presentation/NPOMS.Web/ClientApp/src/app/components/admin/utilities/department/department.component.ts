...
export class DepartmentComponent implements OnInit {
  ...
  private createEntity() {
    this._dropdownRepo.createEntity(this.entity, DropdownTypeEnum.Departments).subscribe(resp => {
      this.loadEntities();
  ...
  private updateEntity() {
    this._dropdownRepo.updateEntity(this.entity, DropdownTypeEnum.Departments).subscribe(resp => {
      this.loadEntities();
