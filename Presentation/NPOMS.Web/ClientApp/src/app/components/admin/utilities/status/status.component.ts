...
export class StatusComponent implements OnInit {
  ...
  entities: IStatus[];
  entity: IStatus = {} as IStatus;
  isEdit: boolean;
  isNew: boolean;
  selectedEntity: IStatus;
  showDialog: boolean;
  inActive: boolean;
  ...
  private loadEntities() {
    this._dropdownRepo.getEntities(DropdownTypeEnum.Statuses, true).subscribe(
      (results) => {
  ...
  private cloneEntity(data: IStatus): IStatus {
    let entity = {} as IStatus;
