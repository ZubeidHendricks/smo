...
export class UtilityManagementComponent implements OnInit {
  ...
  private createEntity() {
    this._dropdownRepo.createEntity(this.entity, DropdownTypeEnum.Utilities).subscribe(
      (resp) => {
        this.loadEntities();
  ...
  private updateEntity() {
    this._dropdownRepo.updateEntity(this.entity, DropdownTypeEnum.Utilities).subscribe(
      (resp) => {
        this.loadEntities();
