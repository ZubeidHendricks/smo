...
export class DocumentTypeComponent implements OnInit {
  ...
  private createEntity() {
    this._dropdownRepo.createEntity(this.entity, DropdownTypeEnum.DocumentTypes).subscribe(resp => {
      this.loadEntities();
  ...
  private updateEntity() {
    this._dropdownRepo.updateEntity(this.entity, DropdownTypeEnum.DocumentTypes).subscribe(resp => {
      this.loadEntities();
