...
export class ActivityTypeComponent implements OnInit {
  ...
  private createEntity() {
    this._dropdownRepo.createEntity(this.entity, DropdownTypeEnum.ActivityTypes).subscribe(resp => {
      this.loadEntities();
  ...
  private updateEntity() {
    this._dropdownRepo.updateEntity(this.entity, DropdownTypeEnum.ActivityTypes).subscribe(resp => {
      this.loadEntities();
