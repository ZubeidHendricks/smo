...
export class FacilityTypeComponent implements OnInit {
  ...
  private createEntity() {
    this._dropdownRepo.createEntity(this.entity, DropdownTypeEnum.FacilityTypes).subscribe(
      (resp) => {
        this.loadEntities();
  ...
  private updateEntity() {
    this._dropdownRepo.updateEntity(this.entity, DropdownTypeEnum.FacilityTypes).subscribe(
      (resp) => {
        this.loadEntities();
