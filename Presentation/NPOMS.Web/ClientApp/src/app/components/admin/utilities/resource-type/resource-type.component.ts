...
export class ResourceTypeComponent implements OnInit {
  ...
  private createEntity() {
    this._dropdownRepo.createEntity(this.entity, DropdownTypeEnum.ResourceTypes).subscribe(resp => {
      this.loadEntities();
  ...
  private updateEntity() {
    this._dropdownRepo.updateEntity(this.entity, DropdownTypeEnum.ResourceTypes).subscribe(resp => {
      this.loadEntities();
