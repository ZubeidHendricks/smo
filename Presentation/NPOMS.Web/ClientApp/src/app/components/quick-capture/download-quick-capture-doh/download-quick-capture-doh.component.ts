...
@Component({
  selector: 'app-download-quick-capture-doh',
  templateUrl: './download-quick-capture-doh.component.html',
  styleUrls: ['./download-quick-capture-doh.component.css']
})
export class DownloadQuickCaptureDohComponent implements OnInit {
