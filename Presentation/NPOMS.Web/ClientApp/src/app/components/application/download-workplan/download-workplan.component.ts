...
@Component({
  selector: 'app-download-workplan',
  templateUrl: './download-workplan.component.html',
  styleUrls: ['./download-workplan.component.css'],
  providers: [MessageService, ConfirmationService]
})
export class DownloadWorkplanComponent implements OnInit {
