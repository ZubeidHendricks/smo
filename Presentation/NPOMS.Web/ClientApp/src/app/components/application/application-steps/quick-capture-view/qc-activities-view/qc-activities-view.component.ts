...
@Component({
  selector: 'app-qc-activities-view',
  templateUrl: './qc-activities-view.component.html',
  styleUrls: ['./qc-activities-view.component.css']
})
export class QCActivitiesViewComponent implements OnInit {
