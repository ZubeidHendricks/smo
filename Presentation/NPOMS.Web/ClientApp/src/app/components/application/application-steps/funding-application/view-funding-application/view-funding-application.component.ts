...
import { PermissionsEnum, ApplicationTypeEnum, ServiceProvisionStepsEnum, FundingApplicationStepsEnum, StatusEnum } from 'src/app/models/enums';
import { IPlace, ISubPlace, IUser, IApplication, IObjective, IActivity, ISustainabilityPlan, IResource, IFundingApplicationDetails, IProjectInformation, IMonitoringAndEvaluation, IApplicationDetails, IApplicationPeriod } from 'src/app/models/interfaces';
...
@Component({
  selector: 'app-view-funding-application',
  templateUrl: './view-funding-application.component.html',
  styleUrls: ['./view-funding-application.component.css']
})
