...
@Component({
  selector: 'app-qc-objectives',
  templateUrl: './qc-objectives.component.html',
  styleUrls: ['./qc-objectives.component.css'],
  providers: [MessageService, ConfirmationService]
})
export class QcObjectivesComponent implements OnInit {
