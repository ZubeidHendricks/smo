...
import { IActivity, IApplication, IApplicationComment, IApplicationReviewerSatisfaction, IDepartment, IFinancialYear, IObjective, IObjectiveProgramme, IProgramme, IQuarterlyPeriod, IRecipientType, ISubProgramme, ISubRecipient, ISubSubRecipient } from 'src/app/models/interfaces';
...
@Component({
  selector: 'app-qc-objectives-edit',
  templateUrl: './qc-objectives-edit.component.html',
  styleUrls: ['./qc-objectives-edit.component.css'],
  providers: [MessageService, ConfirmationService]
})
export class QcObjectivesEditComponent implements OnInit {
  ...
  saveObjective() {
    ...
    this.objective.fundingPeriodStartDate = this.objective.fundingPeriodStartDate == null ? '' : this._datepipe.transform(this.objective.fundingPeriodStartDate, 'yyyy-MM-dd');
    this.objective.fundingPeriodEndDate = this.objective.fundingPeriodEndDate == null ? '' : this._datepipe.transform(this.objective.fundingPeriodEndDate, 'yyyy-MM-dd');
