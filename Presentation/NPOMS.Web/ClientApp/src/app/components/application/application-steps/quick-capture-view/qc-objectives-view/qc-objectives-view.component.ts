...
@Component({
  selector: 'app-qc-objectives-view',
  templateUrl: './qc-objectives-view.component.html',
  styleUrls: ['./qc-objectives-view.component.css'],
  providers: [MessageService, ConfirmationService]
})
export class QcObjectivesViewComponent implements OnInit {
