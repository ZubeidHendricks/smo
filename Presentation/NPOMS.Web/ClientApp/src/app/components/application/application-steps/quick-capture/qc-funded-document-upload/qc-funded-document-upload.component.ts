...
@Component({
  selector: 'app-qc-funded-document-upload',
  templateUrl: './qc-funded-document-upload.component.html',
  styleUrls: ['./qc-funded-document-upload.component.css']
})
export class QcFundedDocumentUploadComponent implements OnInit {
