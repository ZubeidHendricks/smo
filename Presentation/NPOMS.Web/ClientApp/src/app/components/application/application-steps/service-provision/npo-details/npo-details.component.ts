...
export class NpoDetailsComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.validationErrors.push({ severity: 'warn', summary: "Warning:", detail: "Application already captured. Please go to 'Captured Applications' to access this application." });
  }
