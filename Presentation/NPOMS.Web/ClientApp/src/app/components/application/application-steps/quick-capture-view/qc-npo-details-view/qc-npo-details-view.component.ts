...
@Component({
  selector: 'app-qc-npo-details-view',
  templateUrl: './qc-npo-details-view.component.html',
  styleUrls: ['./qc-npo-details-view.component.css'],
  providers: [MessageService, ConfirmationService]
})
export class QcNpoDetailsViewComponent implements OnInit {
