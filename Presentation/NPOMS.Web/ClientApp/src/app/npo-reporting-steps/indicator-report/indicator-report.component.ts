...
export class IndicatorReportComponent implements OnInit {
  ...
  data = [
    ...
    { column1: 'Output Description', column2: 'Example Output Description[Indicator Description]', column3: '', column4: '',column5: '' },
    { column1: 'TARGETS', column2: '', column3: '', column4: '' }, // Row 3 with only one column
    { column1: 'Quarters to report on', column2: '  Q1', column3: 'Q2', column4: 'Q3',column5: 'Q4' },
    { column1: 'Targerts DSD', column2: '', column3: '', column4: '',column5: '' },
    { column1: 'NPO Targets achieved', column2: '', column3: '', column4: '',column5: '' },
    { column1: 'Variance Calculated', column2: '', column3: '', column4: '',column5: '' },
    { column1: 'Reasons for Variannce and corrective action', column2: '', column3: '', column4: '' ,column5: ''},
    { column1: 'Notes and supporting documents', column2: '', column3: '', column4: '',column5: 'Click here to upload Document' }
  ];

  getTotal(data) {
    // Example method to calculate a total (modify as needed)
    return data.length;
  }
