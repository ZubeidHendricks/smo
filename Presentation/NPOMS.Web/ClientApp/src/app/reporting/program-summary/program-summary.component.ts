...
import { IActivity, IApplication, IFinancialYear, INPOIndicator, IUser, IWorkplanIndicator } from 'src/app/models/interfaces';
...
export class ProgramSummaryComponent implements OnInit {
  ...
  private loadIndicators() {
    this._dropdownRepo.getEntities(DropdownTypeEnum.HighLevelNPO, false).subscribe(
      (results) => {
        this.iNPOIndicators = results;
        console.log('munei',this.iNPOIndicators);
